	...
	public function bdthemes_element_pack_get_feeds_posts_data() {
		...
		<div class="bdt-ep-overview__feed">
			...
			<div class="bdt-ep-overview__footer bdt-ep-divider_top">
				<ul>
					<li>
						<a href="https://bdthemes.com/blog/"><?php echo esc_html__('Blog', 'bdthemes-element-pack-lite'); ?>
							<span aria-hidden="true" class="dashicons dashicons-external"></span>
						</a>
					</li>
					<li>
						<a href="https://bdthemes.com/knowledge-base"><?php echo esc_html__('Docs', 'bdthemes-element-pack-lite'); ?>
							<span aria-hidden="true" class="dashicons dashicons-external"></span>
						</a>
					</li>
					<li>
						<a href="https://www.elementpack.pro/pricing/"><?php echo esc_html__('Get Pro', 'bdthemes-element-pack-lite'); ?>
							<span aria-hidden="true" class="dashicons dashicons-external"></span>
						</a>
					</li>
					<li>
						<a href="https://feedback.elementpack.pro/announcements"><?php echo esc_html__('Changelog', 'bdthemes-element-pack-lite'); ?>
							<span aria-hidden="true" class="dashicons dashicons-external"></span>
						</a>
					</li>
				</ul>
